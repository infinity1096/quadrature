...
void Axis::limitOutputVoltage(float32_t aVdq0Input[3], float32_t aVdq0Output[3]){
    ...
    aVdq0Output[0] = clip(aVdq0Input[0], -theMaxModulationVoltage, theMaxModulationVoltage);
    aVdq0Output[1] = clip(aVdq0Input[1], -theMaxModulationVoltage, theMaxModulationVoltage);
}
